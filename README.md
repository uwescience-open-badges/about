...
2. **Email** a PDF of your poster/slides/paper, or a URL to it, to `bmarwick@uw.edu`, **upload** it to a new issue on our [submissions](https://github.com/uwescience-open-badges/submissions/issues/new) repository , or **share the URL** of your file with us in a new issues on our [submissions](https://github.com/uwescience-open-badges/submissions/issues/new) repository.
